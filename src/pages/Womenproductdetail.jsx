...
import { removeproduct } from "../store/reducer/WomenSlice"
import Form from 'react-bootstrap/Form';
import { womenclothapi } from "../store/actions/womenasync"
import { ToastContainer, toast } from 'react-toastify';
import 'react-toastify/dist/ReactToastify.css';


const Womenproductdetail = ({cart,setcart}) => {
...
/>
    ...
    <Link className="bg-[#FA8900] hover:bg-[#ea5454] px-5 py-2 text-black rounded-full">Buy Now</Link>
        </div>
