...
/>
    ...
    <div className="w-full h-full px-5 lg:px-2 md:my-10 mt-20 flex flex-col items-center md:items-start md:flex-row gap-5 " key={value.id}>
      <div className="w-[100%] md:w-[40%]   flex justify-center  rounded-lg">
        <img src={value.image} className="sm:w-[280px] mix-blend-multiply  h-[200px] lg:h-[40vh]"  alt="" />
      </div>
      <div className="flex flex-col gap-3 sm:gap-5 w-fit ">
